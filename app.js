...
function multiply(a, b) { //eslint-disable-line
    var multiply = a * b;
    var summary = 'The product of ' + a + ' and ' + b + ' is ' + multiply + '.';
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    var sum = a + b + c;
    var multiply = a * b * c;
    var summarySum = a + ' and ' + b + ' and ' + c + ' sum to ' + sum + '.';
    var summaryMultiply = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + multiply + '.';
    return [sum, multiply, summarySum, summaryMultiply];
}
...
function sumArray(testArray) { //eslint-disable-line
    ...
    var summary = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' +  sumArr + ' is their sum.'; 
    return [sumArr, summary];
}
...
function multiplyArray(multArr) { //eslint-disable-line
    ...
    for (var j = 0; j < testArray.length; j++){
        multArr = multArr*testArray[j];
    }
    var summary = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + multArr +'.';
    return [multArr, summary];
}
